...
class urunler(db.Model):
	...
	kategori_id=db.Column(db.Integer(), db.ForeignKey('users.id', ondelete='CASCADE'))
	urunresmi=db.Column(db.String(80))
	urunFiyati=db.Column(db.Integer)
	markaId=db.Column(db.Integer(), db.ForeignKey('users.id', ondelete='CASCADE'))
	def __init__(self, kategori_id, urun_ozellikleri,urun_fiyati,markaId):
...
class musteri(db.Model):
	...
	kullaniciId=db.Column(db.Integer(), db.ForeignKey('users.id', ondelete='CASCADE'))
...
class siparis(db.Model):
	...
	musteriId=db.Column(db.Integer(), db.ForeignKey('users.id', ondelete='CASCADE'))
	urunId=db.Column(db.Integer(), db.ForeignKey('users.id', ondelete='CASCADE'))
	siparisno=db.Column(db.Integer)
	siparisTarihi=db.Column(db.Integer)
	odemeId=db.Column(db.Integer(), db.ForeignKey('users.id', ondelete='CASCADE'))
