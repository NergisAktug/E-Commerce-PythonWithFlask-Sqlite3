...
class urunler(db.Model):
	...
	kategori_id=db.Column(db.Integer(), db.ForeignKey('kategori.id', ondelete='CASCADE'))
	urunresmi=db.Column(db.String(80))
	urunFiyati=db.Column(db.Integer)
	markaId=db.Column(db.Integer(), db.ForeignKey('marka.id', ondelete='CASCADE'))
...
class siparis(db.Model):
	...
	musteriId=db.Column(db.Integer(), db.ForeignKey('musteri.id', ondelete='CASCADE'))
