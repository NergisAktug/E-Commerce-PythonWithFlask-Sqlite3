...
class urunler(db.Model):
	...
	urun_ozellikleri=db.Column(db.String(80))
	urun_fiyati=db.Column(db.Integer)
	urun_stok=db.Column(db.Integer)
...
class musteri(db.Model):
	...
	telefon=db.Column(db.Integer(80),unique=True)
	sifre=db.Column(db.String(80))
...
class siparis(db.Model):
	...
	faturaId=db.Column(db.Integer)
	def __init__(self,musteriId,siparisno,siparisTarihi,faturaId):
		self.m
