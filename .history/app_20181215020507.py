...
def create_app():
    ...
    class urunler(db.Model):
        ...
        urunadeti=db.Column(db.Integer)
    ...
    def urunEklemeYap():
        ...
        urunAdeti=request.form['urunadeti']
        markaId=request.form['markaId']
        yeniUrun=urunler(urunismi=urunismi,urunresmi=urunResmi,urunFiyati=urunFiyati,urunadeti=urunadeti,markaId=markaId)
